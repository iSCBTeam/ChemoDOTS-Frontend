...
def searchFct(smiles):
    ...
    amine_prim_alkyl.name="alkyl primary amine"
    ...
    aziridine_alkyl.exclu=["alkyl secondary amine"]

    aziridine_aryl=Chem.MolFromSmarts('C1NC1c')

    aziridine_aryl.name="Aziridine aryl"

    aziridine_aryl.exclu=["alkyl secondary amine"]
    ...
    amidine_alkyl.exclu=["Imine alkyl","alkyl primary amine"]

    amidine_aryl=Chem.MolFromSmarts('c[C;R0](N)=N')

    amidine_aryl.name="Amidine aryl"

    amidine_aryl.exclu=["Imine aryl","alkyl primary amine"]
    ...
    amide_alkyl.exclu=["Amide 1","alkyl primary amine"]

    amide_aryl=Chem.MolFromSmarts('c[C;R0]([NH2])=O')

    amide_aryl.name="Amide aryl"

    amide_aryl.exclu=["Amide 1","alkyl primary amine"]
    ...
    imide_alkyl.exclu=["Amide 2","alkyl secondary amine"]

    imide_aryl=Chem.MolFromSmarts('c[C;R0](=O)N[C;R0](=O)c')

    imide_aryl.name="Imide aryl"

    imide_aryl.exclu=["Amide 2","alkyl secondary amine"]
